# test the fill_empty_event_origin.py module (one shot DB fix)
# (the tests of buildings_diff_fields/building_identicals moved to batid/tests/test_bdg_diff.py)
# for the tests to pass, you need to deactivate some protections set up in dbrouters.py
# => tests are commented for this reason
...
# from batid.services.bdg_diff import buildings_diff_fields
