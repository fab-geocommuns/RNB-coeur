from api_alpha.serializers.event_annotation import EventAnnotationSerializer
...
class BuildingEventSerializer(serializers.Serializer):
    def to_representation(self, instance):
        ...
        # Reviewer annotations attached to this event (event_id).
        ...
        instance_copy["annotations"] = EventAnnotationSerializer(
