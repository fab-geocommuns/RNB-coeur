...
def analyze(report_path):
    ...
    for row in data:
        ...
        print('first  :', row['matches'][0]['rnb_id'], row['matches'][0]['score'], row['matches'][0].get("sub_scores", None))
        print('second  :', row['matches'][1]['rnb_id'], row['matches'][1]['score'], row['matches'][1].get("sub_scores", None))
        print('third  :', row['matches'][2]['rnb_id'], row['matches'][2]['score'], row['matches'][2].get("sub_scores", None))
