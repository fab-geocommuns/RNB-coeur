        ...
        with connections['default'].cursor() as cursor:
            ...
            for idx, feature in enumerate(self.city_bdgs):
                ...
                stats.append({
                    ...
                    "created_at": feature['properties']['BATIM_DATECRE'] if feature['properties']['BATIM_DATECRE'] else "VIDE",
                    "removed_at": feature['properties']['BATIM_DATESUPP'] if feature['properties']['BATIM_DATESUPP'] else "VIDE",
                })
            ...
            print("-----")
            print("### Comparaison stock total VS no match selon critères BATIM_VALID ###")
            ...
            v_compare = pd.concat([valid_all_count, valid_all_percent, valid_nomatch_count, valid_nomatch_percent], axis=1)
            ...
            print("-----")
            print("### Comparaison stock total VS no match selon critères BATIM_DATECRE ###")
            ...
            year_compare = pd.concat([year_all_size, year_all_percent, year_nomatch_size, year_nomatch_percent], axis=1)
